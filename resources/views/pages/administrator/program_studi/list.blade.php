@extends('layout.main')
@section('title','Administrator - Program Studi List')
@section('content')
<div class="m-3 text-end">
    <a href="{{route('createPStudi')}}" class="btn btn-primary">Buat data baru</a>
</div>
...
<table class="table table-striped my-3">
    <thead>
      <tr>
        <th scope="col">No</th>
        <th scope="col">Nama Pemegang Program Studi</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{route('editPStudi',$data->id)}}" class="text-decoration-none text-black fa fa-edit"></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Apakah anda ingin menghapus data dekan '{{$data->user->name}}' ?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                <form data-bs-remote="true" action="{{route('deletePStudi',$data->user_id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('DELETE')
