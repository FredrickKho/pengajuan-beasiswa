@extends('layout.main')
@section('title','Administrator - Dekan List')
@section('content')
<div class="m-3 text-end">
    <a href="{{route('createDekan')}}" class="btn btn-primary">Buat data baru</a>
</div>
...
<table class="table table-striped my-3">
    <thead>
      <tr>
        ...
        <th scope="col">Ketua/Wakil Ketua</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{route('editDekan',$data->id)}}" class="text-decoration-none text-black fa fa-edit"></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form data-bs-remote="true" action="{{route('deleteDekan',$data->user_id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('DELETE')
