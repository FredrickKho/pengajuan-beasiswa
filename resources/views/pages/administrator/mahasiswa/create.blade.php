@extends('layout.main')
@section('title','Administrator - Create Mahasiswa')
@section('content')
...
<div class="d-flex justify-content-center my-4">
    <form accept="{{route('createMahasiswa')}}" enctype="multipart/form-data" method="POST" class="px-5 py-4 w-50" style="border-radius: 4px;box-shadow: 0 0 20px; background-color: #f4f6f9">
        @csrf
